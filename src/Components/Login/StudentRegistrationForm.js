      ...
      .then((imgData) => {
        if (imgData.success) {
          ...
          const student = {
            ...
            yearGradeLevel: data.yearGradeLevel,
            city: data.city,
              ...
              <div className="flex gap-7">
                ...
                <div className="form-control w-full">
                  ...
                  <select
                    name="yearGradeLevel"
                    className="input input-sm input-bordered w-full"
                    {...register("yearGradeLevel")}
                  >
                    <option value="">Select Year/Grade Level</option>
                    <option value="1">1st Year/Grade</option>
                    <option value="2">2nd Year/Grade</option>
                    <option value="3">3rd Year/Grade</option>
                    <option value="4">4th Year/Grade</option>
