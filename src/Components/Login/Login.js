...
//         <div className="card max-w-md bg-gradient-to-r from-neutral via-teal-50 to-slate-50 shadow-xl">
...
const Login = () => {
  ...
  // const onSubmit = (data) => {
  //   fetch(`http://localhost:5000/${selectedRole}`, {
  //     method: "POST",
  //     headers: {
  ...
  const onSubmit = (data) => {
    const matchingUser = loggedUser.find(
      (sysUser) => sysUser.email === data.email && sysUser.role === selectedRole
    );
    if (matchingUser) {
      console.log(data);
      ...
      <div className="lg:w-1/2 lg:pt-28 p-8">
        <div className="card max-w-md bg-gradient-to-r from-neutral via-teal-50 to-slate-50 shadow-xl">
          <div className="card-body">
            ...
            {!selectedRole && ( // Render role selection buttons if role is not selected
            ...
            {selectedRole && ( // Render email and password fields if role is selected
              <form onSubmit={handleSubmit(onSubmit)}>
                {/* email field */}
                <div className="form-control">
                  <label className="label">
            ...
            <p className="text-center mt-4">
              <small className="font-semibold">
                New to Edu-Trio-Dynamix? Create new account{" "}
                <Link className="text-green-800" to="/register">
                  here
                </Link>
              </small>
